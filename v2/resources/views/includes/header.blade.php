...
<div class="bg-navbar navbar-default mega-menu" role="navigation">
    ...
    <div class="navbar-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a style="margin-bottom: 80px;" class="navbar-brand" href="{{ url('/') }}">
                                    <img class="img-responsive" id="logo-header" src="{{ url('frontend/assets/img/logo-310x310.png') }}" alt="Utsab Logo">
                                </a>
    ...
    <div class=" collapse navbar-collapse navbar-responsive-collapse navbar-color" >
        <div class="container navbar-padding">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="{{ url('executive-commitee') }}">Exe. Committee</a>
                </li>
                <!-- End Our Executive Committee -->
                <!-- Puja Schedule -->
                <li>
                    <a href="{{ url('puja-schedule') }}">Puja Schedule</a>
                </li>
                <!-- End Puja Schedule -->
                <!-- Our Events -->
                <!-- <li>
